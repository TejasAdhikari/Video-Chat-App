...
public class ProfileActivity extends AppCompatActivity {
    ...
    private ImageView backgropund_profile_view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backgropund_profile_view = findViewById(R.id.background_profile_view);
        name_profile = findViewById(R.id.name_profile);
        add_friend = findViewById(R.id.add_friend);
        decline_friend_request = findViewById(R.id.decline_friend_request);

        Picasso.get().load(receiverUserImage).into(backgropund_profile_view);
